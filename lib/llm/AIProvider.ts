...
/**
 * Provider genérico que funciona con cualquier modelo configurado
 * Soporta OpenAI, Google Gemini y otros via AI SDK
 */
export class AIProvider implements LLMProvider {
  ...
  async generateText(prompt: string, options?: any): Promise<string> {
    const result = await generateText({
      model: this.getModelInstance() as any,
      prompt,
      ...options
    });
